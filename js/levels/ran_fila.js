// levels/ran_fila.js — the Ranger quest filler level "a" (dat/Ran-fila.lua),
// used for quest-branch levels between Ran-strt and the locate level
...
import { COLNO, ROOM, ROWNO, STONE, TREE } from '../const.js';
...
export async function makemaz_ran_fila() {
    const g = game;
    ...
    try {
        ...
        for (let i = 0; i < 3; i++) quest_monster_named_rnd('forest centaur', 0);
